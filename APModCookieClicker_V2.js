...
//AP Connection Script - Should move the Source..
/*
const scriptAP = document.createElement('script')
scriptAP.src = 'https://sommer-alexander.de/APHelper/archipelago100.js';
scriptAP.type = 'text/javascript';
document.head.append(scriptAP);
*/
...
function releaseAll() {
    window.client.locations.auto_release();
}
...
function appendFunctions() {
    ...
    if (window.client.data.slotData.advancement_goall !== null) {
        goalAchievmentCount = window.client.data.slotData.advancement_goall;
    }
